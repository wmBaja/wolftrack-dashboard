    ...
    <div class="mx-auto px-4">
      <div class="flex items-center justify-between h-14">
        ...
        <div class="flex items-center gap-4 h-full">
          <button @click="fileManagerRef?.openPanel()" class="p-2 text-[var(--color-muted)] hover:text-[var(--color-text)] transition-colors rounded-md hover:bg-[var(--color-hover)]" aria-label="Open File Manager">
